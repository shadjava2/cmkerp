...
/**
 * Query Service pour la gestion des lignes de réception de transfert interne (lecture uniquement) - module POS.
 */
@Service("posLigneReceptionTransfertInterneQueryService")
