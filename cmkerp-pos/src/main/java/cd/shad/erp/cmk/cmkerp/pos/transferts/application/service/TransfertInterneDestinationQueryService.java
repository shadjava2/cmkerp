...
/**
 * Query Service pour récupérer les pharmacies destinations éligibles pour un transfert interne (module POS).
 *
 * <p>Retourne toutes les pharmacies actives en base, à l'exception de la pharmacie source.
 */
@Service("posTransfertInterneDestinationQueryService")
