...
import cd.shad.erp.cmk.cmkerp.stocks.transferts.application.service.ReceptionTransfertInterneCommandService;
import cd.shad.erp.cmk.cmkerp.stocks.transferts.application.service.ReceptionTransfertInterneQueryService;
...
/**
 * Contrôleur REST pour la gestion des réceptions de transferts internes.
 */
@RestController
@RequestMapping(RECEPTIONS_TRANSFERTS_INTERNES_BASE)
@RequiredArgsConstructor
@Tag(name = "Réceptions Transferts Internes", description = "Gestion des réceptions de transferts internes")
@Validated
@Slf4j
